...
if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit']))
{
	...
	$stmt = $conn->prepare("SELECT * FROM online_cbt_admin_user where Password=? AND User_Name=? Limit 1");
	...
	<!-- middle content starts here where vertical nav slides and news ticker statr -->
		<div class="row">
			...
			<div  class="col-lg-12" style="width:100%; padding-top:10px; padding-left:5px; padding-bottom:10px; background-color:grey;margin-bottom:1%">
						<h3 style="text-align:center;color:white">CBT Administrator's Login Platform</h3>
					</div>
...
font-family: tahoma" id="txtUsername" name="txtUsername" value="<?php echo $txtUsername; ?>" placeholder="Enter User_Name">
															</div>
														</div>
								</div>
				<div class="form-group">
...
font-family: tahoma" id="txtPassword" name="txtPassword" value="" placeholder="Enter Password">
															</div>
														</div>
								</div>
