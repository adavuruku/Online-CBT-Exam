...
if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit']))
{
	...
	if($affected_rows == 1) 
	{
		...
		if($row['Exam_Status'] == "0"){
			...
			$error = "<p >Sorry! You have Not Write This Exam and No Result</p>";
		}
		else
		{
					$_SESSION['movin_nxtpagee'] = $txtUsername;
					$_SESSION['movin_result_nxtpagee'] = "yes";
					$_SESSION['reprint'] = "reprint";
	...
	<!-- middle content starts here where vertical nav slides and news ticker statr -->
		<div class="row">
			...
			<div  class="col-sm-7 col-md-7 col-lg-7">
						...
						<h3 style="text-align:center;padding-top:5px; padding-bottom:25px;color:yellow" >CBT User's Re - Print Result Slip Platform</h3>
					</div>
...
font-family: tahoma" id="txtPassword" name="txtPassword" value="" placeholder="Enter Your Password">
				...
				<div  class="col-lg-12" style="width:100%; padding-top:10px; padding-left:5px; padding-bottom:10px; background-color:grey;margin-bottom:1%">
								...
								<div  class="col-lg-7" >
											<button  type="submit"  name="submit" class="btn btn-success">Re - Print Result Slip</button>
