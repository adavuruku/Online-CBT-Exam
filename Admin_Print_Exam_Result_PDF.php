...
{ 
		...
		if ($stmt->rowCount () >= 1)
		{
			...
			header("location: Server_Pictures_Print/All_Exam_Result_Slip.php");
	...
	<!-- middle content starts here where vertical nav slides and news ticker statr -->
		<div class="row">
			...
			<div  class="col-lg-12" style="width:100%; padding-top:10px; padding-left:5px; padding-bottom:10px; background-color:grey;margin-bottom:1%">
							<h3 style="text-align:center;padding-top:5px; padding-bottom:25px;color:yellow" >Admin - Print All Exam Result in PDF Format</h3>
				</div>
...
font-family: tahoma" class="form-control" value="" id="cmbexamschedule" name="cmbexamschedule">
				...
				<div  class="col-lg-12" style="width:100%; padding-top:10px; padding-left:5px; padding-bottom:10px; background-color:grey;margin-bottom:1%">
								...
								<div  class="col-lg-7" >
											<button  type="submit"  name="submit" class="btn btn-success">Download Result (PDF)</button>
								</div>
							</form>
				</div>
