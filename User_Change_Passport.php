...
if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit']))
{
	...
	$stmt = $conn->prepare("SELECT User_Password,Reg_No,Login_Status FROM online_cbt_user where User_Password=? AND Reg_No=? Limit 1");
	...
	if($affected_rows == 1) 
	{
		...
		else
		{
			...
			$_SESSION['Reg_No_Print'] = $row['Reg_No'];
			$_SESSION['user_chaange_passport'] = "User_login";
	...
	<!-- middle content starts here where vertical nav slides and news ticker statr -->
		<div class="row">
			...
			<div  class="col-lg-12" style="width:100%; padding-top:10px; padding-left:5px; padding-bottom:10px; background-color:grey;margin-bottom:1%">
						<h3 style="text-align:center;padding-top:5px; padding-bottom:25px;color:yellow" >CBT User's Login Platform</h3>
					</div>
